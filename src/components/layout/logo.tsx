...
export function Logo({ className }: { className?: string }) {
  return (
    <Link href={routes.home} className={cn('group flex items-center gap-2.5', className)}>
      <span className="from-brand-500 to-brand-700 shadow-glow grid h-9 w-9 place-items-center rounded-xl bg-gradient-to-br transition-transform group-hover:scale-105">
